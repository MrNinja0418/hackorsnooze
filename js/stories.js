...
/** Fetches and displays stories when the site first loads. */
 ...
 * - showDeleteBtn: whether to show the delete button
 *
...
/** Generates HTML for the delete button for a story */
...
/** Generates HTML for the favorite/not-favorite star for a story */
...
/** Retrieves list of stories from the server, generates their HTML, and displays on page. */
...
/** Displays the favorites list on page. */
...
async function toggleStoryFavorite(evt) {
  ...
  // Check if the item is already favorited (checking by presence of star)
  if ($tgt.hasClass("fas")) {
